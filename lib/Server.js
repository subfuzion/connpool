...
class Server extends EventEmitter {
   ...
   * This is a simple demo server that waits 3-10 seconds before responding with a JSON message
   ...
   * Creates a simple demo server that waits 3-10 seconds before responding with a JSON message
   * Triggers the 'listening' event
   * Triggers the 'connection' event when request is received
   * The server's response message will be a copy of the received message, plus 2 extra fields:
   *   - timeReceived
   *   - timeCompleted (based on a random time to process from 3-10 seconds, inclusive)
